...
class Model(nn.Module):
    ...
    def __call__(
        ...
        stream: bool = False,
        sensor: str = "rgb",
        source2: Union[str, Path, int, Image.Image, list, tuple, np.ndarray, torch.Tensor] = None,
        **kwargs: Any,
    ) -> list:
        """
        ...
        """
        return self.predict(source, stream, sensor, source2, **kwargs)
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        return self.predictor.predict_cli(source=source) if is_cli else self.predictor(source=source, stream=stream, sensor=sensor, source2=source2)
